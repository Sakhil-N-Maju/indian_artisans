          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1 mt-1">
              {metric.change > 0 ? (
                ...
                <TrendingDown className={`h-3 w-3 ${metric.trend === 'up' ? 'text-red-500' : 'text-green-500'}`} />
              )}
              <span className={metric.change > 0 ? (metric.trend === 'up' ? 'text-green-500' : 'text-red-500') : (metric.trend === 'up' ? 'text-red-500' : 'text-green-500')}>
